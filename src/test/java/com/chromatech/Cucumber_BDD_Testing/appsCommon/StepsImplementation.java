...
public class StepsImplementation extends PageInitializer{
    ...
    /**
     * Deletes a test sibling account with the given admission number and class section.
     *
     * @param admissionNo The admission number of the test sibling account to be deleted.
     */
