Feature: Fees Collection Module
  ...
  Scenario: Fees Collection Module
    ...
    Then the following Fees Collection submodules are displayed "Collect Fees", "Search Fees Payment", "Search Due Fees", "Fees Master", "Fees Group", "Fees Type", "Fees Discount", "Fees Carry Forward", "Fees Reminder"