Feature: Academics Module
  ...
  Scenario: Academics Module displays
    ...
    Then the following submodules are displayed: "Class Timetable", "Teacher Timetable", "Assign Class Teacher", "Promote Students", "Subject Group", "Subjects", "Class", "Section"