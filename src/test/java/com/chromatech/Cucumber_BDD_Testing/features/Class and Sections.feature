Feature: Class and Sections
  ...
  Scenario: Verify classes and sections displayed
    ...
    Then there are two classes, SDET and Cyber Security displayed with the following sections:
      | Class          | Sections                                                                                                                                                                                                                                                                           |
      | Cyber Security | Testing Fundamentals, SDLC Methodologies, Selenium Test Automation, API Testing, Git/GitHub, Java 11 for Cool People, Mobile Test Automation, Accessibility Testing, Database Testing, Networking Fundamentals, Linux Fundamentals, CIA Triad, Penetration Testing/Ethical Hacking |
