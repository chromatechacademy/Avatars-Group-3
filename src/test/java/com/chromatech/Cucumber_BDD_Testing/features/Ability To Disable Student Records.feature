Feature: Ability To Disable Student Records
  ...
  Scenario Outline: Ability To Disable Student Records
    ...
    And the user fills out all fields in admission page "<Admission No>", "<Roll Number>", "<Class>", "<Section>", "<First Name>", "<Last Name>", "<Gender>", "<Date of Birth>", "<Category>", "<Guardian Name>", "<Guardian Phone>"
    ...
    Examples:
      ...
      | 243162823941234 | 32145611234    | SDET  | Cucumber Fundamentals | Shawn      | David     | Male   | 01/27/1990    | Selenium | Jill Ward     | 703098765      |
